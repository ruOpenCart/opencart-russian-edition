...
// Help
$_['help_password']      = 'Просто используйте случайный пароль. Это будет использоваться, чтобы удостовериться, что информация о платеже не вмешивается после отправки на платежный шлюз.';
