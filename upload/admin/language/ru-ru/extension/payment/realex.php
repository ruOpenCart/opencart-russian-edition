...
$_['text_url_message']               = 'Вы должны предоставить URL магазина своему менеджеру аккаунта Realex, прежде чем начать работу';
...
$_['entry_live_demo']                = 'Реальный / Демонстрационный';
$_['entry_auto_settle']              = 'Тип поселения';
$_['entry_card_select']              = 'Выберите карту';
$_['entry_tss_check']                = 'TSS проверка';
$_['entry_live_url']                 = 'URL реального подключения';
$_['entry_demo_url']                 = 'URL демонстрационного подключения';
...
$_['entry_notification_url']         = 'URL уведомлений';
...
$_['help_dcc_settle']                = 'Если Ваш субсчет DCC включен, Вы должны использовать Автоплатеж';
