<?php
// Heading
$_['heading_title']                  = 'First Data EMEA Connect (3DSecure включен)';
...
$_['text_success_void']              = 'Транзакция была аннулирована';
$_['text_success_capture']           = 'Транзакция была получена';
...
$_['entry_live_demo']                = 'Реальный / демо';
$_['entry_auto_settle']              = 'Тип расчета';
$_['entry_card_select']              = 'Выберите карту';
$_['entry_tss_check']                = 'TSS проверка';
$_['entry_live_url']                 = 'URL реального соединения';
$_['entry_demo_url']                 = 'URL демонстрационного соединения';
...
$_['help_notification']              = 'Вам необходимо указать этот URL для First Data, чтобы получать уведомления о платежах';
...
$_['error_live_url']                 = 'URL реального соединения обязателен';
$_['error_demo_url']                 = 'URL демонстрационного соединения обязателен';
$_['error_data_missing']             = 'Данные отсутствуют';
$_['error_void_error']               = 'Невозможно аннулировать транзакцию';
$_['error_capture_error']            = 'Невозможно получить транзакцию';