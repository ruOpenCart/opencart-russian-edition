<?php
// Heading
$_['heading_title']        = 'Возвраты товара';

// Text
$_['text_success']         = 'Успешно: вы изменили возврат!';
...
$_['text_product']         = 'Информация о товаре &amp; Причина возврата';
...
$_['error_permission']     = 'Предупреждение: У вас нет разрешения на изменение возвратов!';
...
$_['error_product']        = 'Название товара должно быть более 3 и менее 255 символов!';
$_['error_model']          = 'Модель товара должно быть больше 3 и меньше 64 символов!';
