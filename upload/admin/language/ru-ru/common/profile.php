...
// Error
$_['error_permission']      = 'Предупреждение: У Вас нет разрешения на изменение профиля!';
$_['error_username_exists'] = 'Предупреждение: Имя пользователя уже используется!';
...
$_['error_email_exists']    = 'Предупреждение: Адрес электронной почты уже зарегистрирован!';