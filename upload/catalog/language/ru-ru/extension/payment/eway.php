...
$_['text_testing']            = 'Этот платежный шлюз в настоящее время проходит тестирование. Ваша кредитная карта не будет снята.<br />Если это реальный заказ, воспользуйтесь альтернативным способом оплаты сейчас.';
...
$_['text_type_help']          = 'После того, как Вы нажмете «Подтвердить заказ», Вы будете перенаправлены на ';
...
$_['text_card_message_V6100'] = 'Invalid Название карты';
...
$_['text_card_message_V6105'] = 'Invalid Номер выпуска карты';
...
$_['text_card_message_F9011'] = 'High Risk Credit Страна карты';
